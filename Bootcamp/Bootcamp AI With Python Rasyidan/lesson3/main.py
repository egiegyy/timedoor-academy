...
handDetect = hd.handDetector(detection_confident=0.8) #Inisialisasi object Hand Detector
...
while True:
    ...
    lmlist = handDetect.getHandLocation(frame, draw=True) #mengambil koordinat seluruh landmark
    # print(lmlist)
    if len(lmlist) != 0:
    ...
    fps = 1 / (current_time - previous_time) #Rumus untuk menghitung nilai frame rate
